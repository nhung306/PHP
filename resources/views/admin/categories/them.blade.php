            ...
            <!--Page Title-->
				...
				<div id="page-content">
					...
					<div class="panel">
								...
								<!--Horizontal Form-->
								<!--===================================================-->
								<form action="{{route('themdanhmuc')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
									 @if(count($errors)>0)
									...
									<div class="panel-body">
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="text" placeholder="tên danh mục" id="demo-hor-inputemail" name="name" class="form-control">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="file" placeholder="Password" id="demo-hor-inputpass" name="image" class="form-control">
											</div>
										</div>
