            ...
            <!--Page Title-->
				...
				<div id="page-content">
					...
					<div class="panel" >
								...
								<!--Horizontal Form-->
								<!--===================================================-->
								<form action="{{route('themslide')}}" method="POST" class="form-horizontal" enctype="multipart/form-data" style="height: 500px; margin-top:100px">
									 @if(count($errors)>0)
									...
									<div class="panel-body">
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="text" placeholder="tên link" id="demo-hor-inputemail" name="link" class="form-control">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-6">
												...
												<input type="text" placeholder="" id="demo-hor-inputemail"  name="type" class="form-control">
											</div>
										</div>
										<div class="form-group">
